...
public class ReportController {
    ...
    public ReportController(OrderRepository orderRepository, OrderDetailRepository orderDetailRepository) {
    ...
    public String editoroder(@RequestParam("id") int id,
                             ModelMap model) {
        model.addAttribute("orderDetails", orderDetailRepository.findById(id));
    ...
    public String editordertr(@ModelAttribute("orderDetail") OrderDetail orderDetail, Model model, RedirectAttributes rs) {
        ...
        if (null != cs) {
            ...
            model.addAttribute("orderDetail", orderDetailRepository.findById(cs.getId()));
        } else {
