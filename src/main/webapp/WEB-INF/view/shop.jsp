					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="shop-sidebar">
								...
								<ul class="shop-cate">
									<c:forEach items="${listAndCountCategory}" var="u">
									<li><a href="productbycategory?categoryId=${u[0]}"> ${u[1]} <span>${u[2]}</span></a></li>
									</c:forEach>
								</ul>

								<h5 class="shop-tittle margin-bottom-30">suppliers</h5>
								<ul class="shop-cate">
									<c:forEach items="${listAndCountSuppliers}" var="u">
										<li><a href="productbysupplier?supplierId=${u[0]}"> ${u[1]} <span>${u[2]}</span></a></li>
									</c:forEach>
								</ul>
							...
							<div class="papular-block row">
								...
								<div class="col-md-4">
									<div class="item">
										<!-- Item img -->
										<div class="item-img">
											<img class="img-1" src="/loadImage?imageName=${productList.image}" alt="">
											<img class="img-2" src="/loadImage?imageName=${productList.image}" alt="">
											<!-- Overlay -->
											<div class="overlay">
												<div class="position-center-center">
													<div class="inn">
														<a href="/loadImage?imageName=${productList.image}" data-lighter><i
															class="icon-magnifier"></i></a> <a href="/addToCart?id=${productList.id}"><i
										...
										<!-- Item Name -->
										<div class="item-name">
											<a href="/productDetail?id=${productList.id}">${productList.name}</a>
<%--											<p>Lorem ipsum dolor sit amet</p>--%>
										</div>
										<!-- Price -->
										<span class="price"><small>$</small>${productList.unitPrice}</span>
									</div>
								</div>
								</c:forEach>
