								...
								<div class="col-sm-12">
									...
									<form:form action="/registered" method="post" modelAttribute="customer">
										<ul class="row">
											...
											<!-- Name -->
											<li class="col-md-6"><label> *FULL NAME <form:input path="fullname" placeholder="Full name" required=" true"></form:input>
											</label></li>


											<!-- EMAIL ADDRESS -->
											<li class="col-md-6"><label> *ID LOGIN <form:input path="id" placeholder="Tên Đăng Nhập" required=" true"></form:input></li>
											<!-- PHONE -->
											<li class="col-md-6"><label> *PASSWORD <form:input type = "password" path="password" placeholder="password" required=" true"></form:input>
											</label></li>

											<!-- LAST NAME -->
											<li class="col-md-6"><label> *EMAIL <form:input  type = "email" path="email" placeholder="email" required="true"></form:input>
											</label></li>
